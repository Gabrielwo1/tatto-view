...
export function FichaPdfDoc({ sub }: { sub: FichaSubmission }) {
  const tatuadoresStr = [
    ...
    <Document title={`Ficha de Anamnese — ${sub.nome}`} author="El Dude Tattoo">
      <Page size="A4" style={S.page}>
        ...
        <View style={S.section}>
          ...
          <View style={S.grid}>
            <View style={S.fieldFull}><Text style={S.fieldLabel}>Nome Completo</Text><Text style={S.fieldValue}>{fmt(sub.nome)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>E-mail</Text><Text style={S.fieldValue}>{fmt(sub.email)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>CPF</Text><Text style={S.fieldValue}>{fmt(sub.cpf)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Data de Nascimento</Text><Text style={S.fieldValue}>{fmtDate(sub.dataNascimento)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Telefone</Text><Text style={S.fieldValue}>{fmt(sub.telefone)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Tel. para Emergência</Text><Text style={S.fieldValue}>{fmt(sub.telefoneEmergencia)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Cidade</Text><Text style={S.fieldValue}>{fmt(sub.cidade)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>CEP</Text><Text style={S.fieldValue}>{fmt(sub.cep)}</Text></View>
            <View style={S.fieldFull}><Text style={S.fieldLabel}>Endereço</Text><Text style={S.fieldValue}>{fmt(sub.endereco)}</Text></View>
          </View>
        </View>
        ...
        <View style={S.section}>
          ...
          <View style={S.grid}>
            <View style={S.fieldFull}><Text style={S.fieldLabel}>Tatuador(es)</Text><Text style={S.fieldValue}>{fmt(tatuadoresStr)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Local do Corpo</Text><Text style={S.fieldValue}>{fmt(sub.localCorpo)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Valor Acordado</Text><Text style={S.fieldValue}>{fmt(sub.valorAcordado)}</Text></View>
            <View style={S.fieldHalf}><Text style={S.fieldLabel}>Data da Sessão</Text><Text style={S.fieldValue}>{fmtDate(sub.dataAssinatura)}</Text></View>
          </View>
        </View>
            ...
            <View style={S.condGrid}>
              {condEntries.map(([label, answer]) => (
                <View key={label} style={S.condRow}>
                  ...
                  {answer === 'sim' ? <Text style={S.condBadgeSim}>SIM</Text> : answer === 'nao' ? <Text style={S.condBadgeNao}>NÃO</Text> : <Text style={S.condBadgeEmpty}>—</Text>}
                </View>
              ))}
            </View>
          )}
        ...
        <View style={S.section}>
          ...
          <View style={S.sigRow}>
            <View style={S.sigField}><View style={S.sigLine} /><Text style={S.sigLabel}>Assinatura do Cliente</Text></View>
            <View style={S.sigField}><View style={S.sigLine} /><Text style={S.sigLabel}>Tatuador Responsável</Text></View>
            <View style={S.sigField}><View style={S.sigLine} /><Text style={S.sigLabel}>Baseado no preenchimento de {fmtDate(sub.dataAssinatura)}</Text></View>
          </View>
        </View>
