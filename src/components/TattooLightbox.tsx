          ...
          <div className="flex items-center justify-between gap-4 pt-4 flex-shrink-0">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {tattoo.status === 'available' && (
                <button
                  onClick={handleAdd}
                  className="shrink-0 font-body text-[10px] font-bold tracking-widest uppercase px-6 py-2.5 bg-white text-black hover:bg-zinc-200 transition-colors flex items-center gap-2"
                >
