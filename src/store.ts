...
const seedArtists: Artist[] = [
  {
    id: 'artist-1',
    name: 'Rafael Mendes',
    bio: 'Tatuador com mais de 10 anos de experiência, especializado em realismo e retratos. Trabalhou em estúdios no Brasil e Europa, trazendo uma visão única para cada peça.',
    photoUrl: 'https://picsum.photos/seed/artist1/400/400',
    specialties: ['Realismo', 'Retratos', 'Blackwork'],
    instagram: '@rafamendes.ink',
    createdAt: new Date('2023-01-15').toISOString(),
  },
  {
    id: 'artist-2',
    name: 'Camila Torres',
    bio: 'Artista plástica e tatuadora apaixonada por aquarela e geometria. Cada tatuagem é tratada como uma obra de arte única, com cores vibrantes e traços precisos.',
    photoUrl: 'https://picsum.photos/seed/artist2/400/400',
    specialties: ['Aquarela', 'Geométrico', 'Minimalista'],
    instagram: '@camilatorres.tattoo',
    createdAt: new Date('2023-03-20').toISOString(),
  },
  {
    id: 'artist-3',
    name: 'Bruno Carvalho',
    bio: 'Especialista em estilos tradicionais e neo-tradicionais. Influenciado pela cultura tattoo americana e brasileira, Bruno cria peças cheias de história e personalidade.',
    photoUrl: 'https://picsum.photos/seed/artist3/400/400',
    specialties: ['Old School', 'Neo-Tradicional', 'Tribal'],
    instagram: '@brunocarvalho.ink',
