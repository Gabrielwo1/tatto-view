        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
          <div className="bg-zinc-950 border border-white/10 w-full max-w-md">
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
              <h2 className="font-display text-xl uppercase tracking-wide">Novo Produto</h2>
              <button
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 flex flex-col gap-4">
              <div>
                <label className="block font-body text-xs font-semibold tracking-widest uppercase text-gray-500 mb-1.5">
                  Nome *
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full bg-black border border-white/10 focus:border-white/40 outline-none px-3 py-2 font-body text-sm text-white placeholder-gray-700 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-black border border-white/10 focus:border-white/40 outline-none px-3 py-2 font-body text-sm text-white placeholder-gray-700 transition-colors resize-none"
