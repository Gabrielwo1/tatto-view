    ...
    <div className="p-4 md:p-8 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <label className="cursor-pointer inline-flex items-center gap-2 border border-white/20 hover:border-white px-4 py-2 text-xs font-body font-semibold tracking-widest uppercase text-gray-400 hover:text-white transition-colors">
        ...
        <div>
          ...
          <textarea name="bio" value={form.bio} onChange={handleChange} rows={4} className={`${inputCls} resize-none`} placeholder="Fale sobre você e seu estilo..." />
        </div>
