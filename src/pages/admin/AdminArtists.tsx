      ...
      {artists.length === 0 ? (
        ...
        <div className="space-y-px">
          ...
          <div className="grid grid-cols-12 px-4 py-2 border-b border-white/10">
            <span className="col-span-5 font-body text-[10px] font-semibold tracking-widest uppercase text-gray-600">Artista</span>
          ...
          {artists.map((artist) => {
            ...
            return (
              <div
                key={artist.id}
                className="grid grid-cols-12 px-4 py-3 border-b border-white/5 hover:bg-white/[0.03] transition-colors items-center"
              >
                {/* Artist info */}
