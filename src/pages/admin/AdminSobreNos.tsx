    ...
    try {
      ...
      reader.onload = async (ev) => {
        try {
          ...
          setForm((f) => {
            const imgs = [...(f.collective.galleryImages ?? ['', '', '', '', '', '', '', '', ''])] as [string, string, string, string, string, string, string, string, string];
            imgs[idx] = src;
      ...
      <div className="space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            {/* ── 9 fotos galeria ── */}
            <div>
              <label className={labelCls}>9 Fotos da Galeria (abaixo do texto)</label>
