...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex">
      {/* Sidebar */}
      <aside className="w-52 bg-black border-r border-white/10 flex flex-col flex-shrink-0">
        {/* Logo */}
        <div className="p-5 border-b border-white/10">
          <Link to="/" className="flex items-center gap-3">
            <img src="/LOGO EL DUDE.jpeg" alt="El Dude" className="h-8 w-auto object-contain" />
